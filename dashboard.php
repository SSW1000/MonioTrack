...
<div class="card mb-3">
            ...
            <h2><i class="fas fa-arrow-down" style="color: green;"></i> Monthly Income</h2>
        </div>
        <div class="card-body">
        <h4><?php echo $preferred_currency . " " . number_format($total_income_month, 2); ?></h4>
        <button type="button" class="btn btn-primary btn-sm" id="addIncomeBtn">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h2><i class="fas fa-arrow-up" style="color: red;"></i> Monthly Expenses</h2>
        </div>
        <div class="card-body">
    ...
    <div class="card-body">
        <canvas id="incomeByCategoryChart" width="100" height="100"></canvas>
    </div>
</div>
...
<div class="card mb-2">
    ...
    <div class="card-body">
        <canvas id="expensesByCategoryChart" width="100" height="100"></canvas>
    </div>
</div>
<div class="card mb-2">
    <div class="card-header">
    ...
    <div class="card-body">
        <canvas id="incomeVsExpensesDonutChart" width="100" height="110"></canvas>
    </div>
</div>
